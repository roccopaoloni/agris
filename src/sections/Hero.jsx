  ...
  return (
    <section className="hero" id="home">
      <video className="hero-video" autoPlay loop muted playsInline>
        <source src="/trigo.mp4" type="video/mp4" />
      </video>
      <div className="hero-overlay"></div>
      <div className="container hero-content text-center fade-in visible">
        <h1 className="hero-title">Administración producción e innovación</h1>
        <h2 className="hero-subtitle">Mag. Ing. Agrónomo Pablo Paoloni</h2>
